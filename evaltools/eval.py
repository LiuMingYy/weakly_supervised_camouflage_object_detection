...
def eval(parser, dataset):
    ...
    if args.record_path is not None:
        ...
        txt = '/mnt/disk/lym/testDataset/eval/eval_record_hitnet_tem.txt'
    f = open(txt, 'a')
    f.write(eval_record)
    f.write("\n")
    f.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", default='SARNet_v2')
    parser.add_argument("--pred_root", default='/mnt/disk/lym/COD10K/result/COD10K/SARNet/exp2')
    parser.add_argument("--GT_root", default='/mnt/disk/lym/COD10K/TestDataset/COD10K/GT')
    parser.add_argument("--record_path", default='/mnt/disk/lym/COD10K/result/COD10K/SARNet/SARNet_exp2.txt')
    parser.add_argument("--BR", default='off')
    parser.add_argument("--br_rate", default=15)
    args = parser.parse_args()
    # datasets = ['NC4K', 'COD10K', 'CAMO', 'CHAMELEON']
    print('exp2')
    eval(parser,dataset='COD10K')
