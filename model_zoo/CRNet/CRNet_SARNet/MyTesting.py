...
parser.add_argument('--pth_path', type=str, default='/mnt/disk/lym/COD10K/result/COD10K/CRNet_exp_SARNet/model-best.pth')
...
for _data_name in ['COD10K']:
    ...
    save_path = f'/mnt/disk/lym/COD10K/result/COD10K/CRNet/{EXP_NAME}/'
