...
parser.add_argument('--pth_path', type=str, default='/mnt/disk/lym/model_results/weaklySup/CRNet/CRNet_exp_SARNet_insert/weights/model-best.pth')
...
for _data_name in ['COD10K']:
    ...
    data_path = '/mnt/disk/lym/Dataset/COD10K/TestDataset/COD10K'

    save_path = f'/mnt/disk/lym/model_results/weaklySup/CRNet/{EXP_NAME}/prediction/COD10K/'
