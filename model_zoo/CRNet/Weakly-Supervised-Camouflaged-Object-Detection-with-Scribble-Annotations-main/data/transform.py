...
class Compose(object):
    ...
    def __call__(self, image, image1, mask, gt, mask1):
        for op in self.ops:
            image, image1, mask, gt, mask1 = op(image, image1, mask, gt, mask1)
        return image, image1, mask, gt, mask1
...
class ToTensor(object):
    ...
    def __call__(self, image, image1, mask, gt, mask1):
        ...
        return image, image1, mask.mean(dim=0, keepdim=True), gt.mean(dim=0, keepdim=True), mask1.mean(dim=0, keepdim=True)
