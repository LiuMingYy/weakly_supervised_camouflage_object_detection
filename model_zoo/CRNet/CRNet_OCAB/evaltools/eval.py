...
def eval(parser, dataset):
    ...
    model = args.model
    if dataset == 'NC4K':
        gt_root = '/mnt/disk/lym/Dataset/NC4K/GT'
    else:
    ...
    if args.record_path is not None:
        ...
        txt = '/mnt/disk/lym/model_results/weaklySup/CRNet/SARNet_insert_CAMOv2/eval_metrics/eval_record.txt'
    f = open(txt, 'a')
    f.write(eval_record)
    f.write("\n")
    f.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", default='SARNet_insert_CAMOv2')
    parser.add_argument("--pred_root", default='/mnt/disk/lym/model_results/weaklySup/CRNet/SARNet_insert_CAMOv2/prediction')
    parser.add_argument("--GT_root", default='/mnt/disk/lym/Dataset/COD10K/TestDataset')
