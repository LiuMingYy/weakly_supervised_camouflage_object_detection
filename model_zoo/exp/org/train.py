...
EXP_NAME = f'org1'
pvt_name = 'pvt_v2_b3'
savepath = f'/mnt/disk/lym/model_results/weaklySup/MyNet/{EXP_NAME}/'
...
if __name__=='__main__':
    ...
    cfg = dataset.Config(datapath=f'{root}', savepath=savepath, mode='train', batch=6, lr=1e-3, momen=0.9, decay=5e-4, epoch=total_epoch, label_dir = 'Scribble')
    # from net import Net
